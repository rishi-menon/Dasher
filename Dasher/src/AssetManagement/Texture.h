...
public:
	...
	static unsigned int LoadTexture(const unsigned char bufferRgba[], int nSizeX, int nSizeY, TextureProperties props = TextureProperties(0x2601/*GL LINEAR*/, 0x2601, 0x812F /*GL_CLAMP_TO_EDGE*/, 0x812F));
